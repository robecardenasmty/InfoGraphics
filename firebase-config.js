/* ============================================================
   INFO 7 — Credenciales de Firebase
   ------------------------------------------------------------
   Reemplaza cada  PEGA_AQUI_...  por tu valor real de Firebase.
   IMPORTANTE: el valor va DENTRO de las comillas " ".
   Saca los valores de: Firebase Console → ⚙️ Configuración del
   proyecto → "Tus apps" → app Web (</>) → objeto firebaseConfig.
   (databaseURL sale de: Realtime Database, la URL de arriba.)
